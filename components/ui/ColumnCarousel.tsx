      ...
      >
        <div
          ...
          className={`absolute inset-0 transition-opacity duration-300 ease-in-out opacity-100 group-hover:opacity-0 pointer-events-none
            bg-[linear-gradient(260deg,rgba(85,55,105,0.4),rgba(254,194,181,0.25))] light:bg-[linear-gradient(260deg,rgba(233,241,250,0.4),rgba(10,10,10,0.25))]`}
        />
        <Image
          alt="img"
          src={image}
        ...
        <div className="absolute top-0 flex flex-col w-full h-full justify-between p-4">
          <div
            className={`relative left-10 w-[75px] h-fit px-2 py-4 place-self-end rounded-lg border border-white/20 bg-gray-800`}
          >
            <h3
