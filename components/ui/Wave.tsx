...
export default function Wave({ isDarkMode, className }: Waveprops) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1440 320"
      preserveAspectRatio="xMidYMid meet"
      className={`w-full h-auto transition-colors duration-500 ${className}`}
    >
      <path
        fill={isDarkMode ? "#1a181f" : "#e9f1fa"}
        fillOpacity="1"
